...
\begin{figure}[!ht]
    \hspace{-3cm}  % Adjust the horizontal position as needed
    \includegraphics[width=3cm]{sample_image.png}  % Replace with your image file
\end{figure}

\begin{flushright}
    % Top right corner images (two images side by side)
    \begin{minipage}{0.45\textwidth}
        \includegraphics[width=\textwidth]{sample_image1.png}  % Replace with your image file
    \end{minipage} \hspace{0.5cm}
    \begin{minipage}{0.45\textwidth}
        \includegraphics[width=\textwidth]{sample_image2.png}  % Replace with your image file
    \end{minipage}
\end{flushright}
