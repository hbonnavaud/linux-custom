...
\begin{figure}[!ht]
    ...
    \includegraphics[width=3cm]{figures/logos/Republique-francaise-logo.svg.png}
\end{figure}

\begin{flushright}
    % Top right corner images (two images side by side)
    \begin{minipage}{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/logos/Logo_ISEA-Supaéro.png}
    \end{minipage} \hspace{0.5cm}
    \begin{minipage}{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/logos/Logo_universite_toulouse_2023.svg.png}
    \end{minipage}
\end{flushright}
