...
\begin{figure}[!ht]
    \hspace{0cm}  % Adjust the horizontal position as needed
...
\begin{flushright}
    ...
    \begin{minipage}{0.45\textwidth}
        \includegraphics[width=3cm]{figures/logos/Logo_ISEA-Supaéro.png}
    \end{minipage} \hspace{0.5cm}
    \begin{minipage}{0.45\textwidth}
        \includegraphics[width=3cm]{figures/logos/Logo_universite_toulouse_2023.svg.png}
    \end{minipage}
\end{flushright}
