...
\begin{figure}[!ht]
    \centering
    % Left logo
    \includegraphics[width=0.2\textwidth]{figures/logos/Republique-francaise-logo.svg.png}  % Replace with your image file
    \hspace{0.05\textwidth}  % Adjust the space between logos
    % First right logo
    \includegraphics[width=0.2\textwidth]{figures/logos/Logo_ISEA-Supaéro.png}  % Replace with your image file
    \hspace{0.05\textwidth}  % Adjust the space between logos
    % Second right logo
    \includegraphics[width=0.2\textwidth]{figures/logos/Logo_universite_toulouse_2023.svg.png}  % Replace with your image file
\end{figure}
