...
giving the probability of reaching a state $s_{t+1}$ from state $s_t$ after a sequence of actions a_{t, \dots, t+n}. % Alex : tu n'as pas une fonction de transition à écrire ? E.g. $s' = T(s, a_{t, \dots, t+n})$
