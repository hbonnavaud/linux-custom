...
Some algorithms~\citep{andrychowicz2017hindsight} have been developed and optimised to specifically tackle this problem, which could make it a
class of RL algorithms by itself.  % ALEX : une citation au moins.
