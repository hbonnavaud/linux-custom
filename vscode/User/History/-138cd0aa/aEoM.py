...
sub_dirs = [
    '256x256', '256x256@2x', '128x128', '128x128@2x', '48x48', '48x48@2x', 
    '32x32', '32x32@2x', '24x24', '24x24@2x', '22x22', '22x22@2x', '16x16@2x', '16x16'
]
...
def remove_icon(icon_name: str):
    ...
    for directory in pathlib.Path(target_dir).iterdir():
        if directory.name not in sub_dirs:
            continue
...
if not args.names:
    ...
    remove_icon(new_name_with_extension)
else:
