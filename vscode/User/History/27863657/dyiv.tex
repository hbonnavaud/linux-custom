...
% ALEX Par pitié: fait des sauts de ligne à la fin d'un paragraphe/concept!! 
%Si tu veux séparer 2 parties, mets aussi un \\ avant un saut à la ligne pour un espace plus grand (e.g. entre la partie RL et Planning).
...
These algorithms work by simulating millions of games, continuously refining their understanding of strategic moves
without any initial guidance. % ALEX: On peut parler de 'understandig' ici ? C'est plutôt 'evaluation'
...
challenges.
One of the most fundamental issues in RL is exploration: to discover an optimal policy, % ALEX: in an unknown/new environment?
...
computational resources and time. % ALEX: Tu viens de dire'unsafe'. Mets un lien entre ces 2 phrases.
