...
% Hed : Ton example est bon pour moi, je le laisse pour le moment.
...
In Chapter 1, we introduce the fundamental concepts and challenges of reinforcement learning, particularly in 
complex environments. 
Chapter 2 provides the necessary background on reinforcement learning and planning, detailing their theoretical 
foundations and practical applications. 
In Chapter 3, we explore related work, reviewing existing methodologies that combine reinforcement learning with 
planning. 
Chapter 4 presents our proposed approach, focusing on reachability graph learning and its integration with 
hierarchical reinforcement learning. 
In Chapter 5, we extend our approach to robotic applications, showcasing its effectiveness in real-world scenarios. 
Finally, Chapter 6 concludes the thesis by summarizing our findings and discussing potential future research directions.