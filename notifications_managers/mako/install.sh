...
# Creates a symbolic link from ~/.config/mako to linux-custom/mako

SOURCE_DIR=$(dirname "$(realpath "$0")")
TARGET_DIR="$HOME/.config/mako"

echo "Setting up mako configuration symlink..."
...
echo ""
echo "Setup complete! Your mako configuration is now linked to your code directory."
