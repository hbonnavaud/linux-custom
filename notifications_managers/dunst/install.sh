...
# Creates a symbolic link from ~/.config/dunst to linux-custom/dunst

SOURCE_DIR=$(dirname "$(realpath "$0")")
TARGET_DIR="$HOME/.config/dunst"

echo "Setting up dunst configuration symlink..."
...
echo ""
echo "Setup complete! Your dunst configuration is now linked to your code directory."
