...
# Polybar Symlink Setup Script
# Creates a symbolic link from ~/.config/polybar to /code_location/polybar

SOURCE_DIR=$(dirname "$(realpath "$0")")
TARGET_DIR="$HOME/.config/polybar"

echo "Setting up polybar configuration symlink..."
...
echo ""
echo "Setup complete! Your polybar configuration is now linked to your code directory."
