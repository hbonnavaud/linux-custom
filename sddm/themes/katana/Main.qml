...
Pane {
    ...
    property var colors: {
        "button": "transparent",
        "highlight": config.color_katana_grey,
        "text": config.color_katana_dark_grey,
        "buttonText": config.color_katana_dark_grey,
        "window": config.color_pink_bg,
        "color_pinky_white": config.my_white,
    }
    palette.button: "transparent"

    FontLoader {
        id: fontLoader
        source: "Fonts/Electroharmonix.otf"
    }
    ...
    Item {
        ...
        Input {
            ...
            anchors.leftMargin: parent.width * 0.05  // Adjust as needed to control left margin
            z:1
        }
        ...
        SystemButtons {
            ...
            anchors.bottomMargin: root.height * 0.05  // Adjust as needed
            height: root.height / 4
        ...
        Button {
            ...
            contentItem: Text {
                ...
                color: parent.visualFocus ? colors.highlight : colors.text
