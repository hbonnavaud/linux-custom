...
Column {
        ...
        ComboBox {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: Text {
                    ...
                    color: selectUser.highlightedIndex === index ? root.palette.highlight.hslLightness >= 0.7 ? "#444" : root.colors.color_pinky_white : root.palette.window.hslLightness >= 0.8 ? root.palette.hover.hslLightness >= 0.8 ? "#444" : root.colors.hover : root.colors.color_pinky_white
                    verticalAlignment: Text.AlignVCenter
                    horizontalAlignment: Text.AlignHCenter
                }
                highlighted: parent.highlightedIndex === index
                background: Rectangle {
                    color: selectUser.highlightedIndex === index ? root.colors.highlight : "transparent"
                }
            }
            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        target: usernameIcon
                        icon.color: Qt.lighter(root.colors.highlight, 1.1)
                    }
                },
                State {
                    name: "hovered"
                    ...
                    PropertyChanges {
                        target: usernameIcon
                        icon.color: Qt.lighter(root.colors.highlight, 1.2)
                    }
                },
                State {
                    name: "focused"
                    ...
                    PropertyChanges {
                        target: usernameIcon
                        icon.color: root.colors.highlight
                    }
                }
            ]
    ...
    Item {
        ...
        CheckBox {
            ...
            background: Rectangle {
                color: "transparent"
                border.width: 0
                border.color: parent.activeFocus ? root.colors.text : "transparent"
                height: 0
        ...
        states: [
            State {
                ...
                PropertyChanges {
                    ...
                    color: Qt.darker(root.colors.highlight, 1.1)
                }
                PropertyChanges {
                    target: dot
                    color: Qt.darker(root.colors.highlight, 1.1)
                ...
                PropertyChanges {
                    target: indicator
                    border.color: Qt.darker(root.colors.highlight, 1.1)
                }
                PropertyChanges {
            ...
            State {
                ...
                PropertyChanges {
                    ...
                    color: Qt.lighter(root.colors.highlight, 1.1)
                }
                PropertyChanges {
                    target: indicator
                    border.color: Qt.lighter(root.colors.highlight, 1.1)
                }
                PropertyChanges {
                    target: dot
                    color: Qt.lighter(root.colors.highlight, 1.1)
    ...
    Item {
        ...
        Button {
            ...
            contentItem: Text {
                text: parent.text
                color: config.OverrideLoginButtonTextColor != "" ? config.OverrideLoginButtonTextColor : root.palette.highlight.hslLightness >= 0.7 ? "#444" : root.colors.color_pinky_white
            ...
            background: Rectangle {
                id: buttonBackground
                color: root.colors.color_pinky_white
                opacity: 0.2
                radius: config.RoundCorners || 0
            }
            ...
            states: [
                ...
                State {
                    ...
                    PropertyChanges {
                        target: buttonBackground
                        color: Qt.lighter(root.colors.highlight, 1.15)
                        opacity: 1
                    }
                    PropertyChanges {
                        target: loginButton.contentItem
                ...
                State {
                    ...
                    PropertyChanges {
                        target: buttonBackground
                        color: Qt.lighter(root.colors.highlight, 1.2)
                        opacity: 1
                    }
                    PropertyChanges {
                        target: loginButton.contentItem
