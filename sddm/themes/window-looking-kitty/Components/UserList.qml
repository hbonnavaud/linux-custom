    ...
    ComboBox {
        ...
        delegate: ItemDelegate {
            ...
            contentItem: Text {
                ...
                color: selectUser.highlightedIndex === index ? root.colors.color_pinky_white : root.colors.window.hslLightness >= 0.8 ? root.colors.highlight : root.colors.color_pinky_white
