...
RowLayout {
    ...
    Repeater {
        ...
        RoundButton {
            ...
            hoverEnabled: true
            palette.buttonText: root.colors.text_color
            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        ...
                        palette.buttonText: Qt.darker(root.colors.text_highlight_color, 1.1)
                    }
                    PropertyChanges {
                ...
                State {
                    ...
                    PropertyChanges {
                        target: parent.children[index]
                        palette.buttonText: Qt.lighter(root.colors.text_highlight_color, 1.1)
                    }
                    PropertyChanges {
                        target: parent.children[index].background
                ...
                State {
                    ...
                    PropertyChanges {
                        target: parent.children[index]
                        palette.buttonText: root.colors.text_highlight_color
                    }
                    PropertyChanges {
                        target: parent.children[index].background
